'use server';
/**
 * @fileOverview Analyzes a URL for potential phishing attempts.
 *
 * - analyzeURL - Analyzes the URL and returns a risk assessment.
...
import { AnalyzeURLInputSchema, AnalyzeURLOutputSchema, AnalyzeURLInput, AnalyzeURLOutput } from '@/ai/schemas';

export { type AnalyzeURLInput, type AnalyzeURLOutput } from '@/ai/schemas';
